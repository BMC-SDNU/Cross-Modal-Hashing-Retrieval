function [ precision, recall ] = crossMediaQuery_NUS_pr( cat_te, cat_tr, X2_query_binary, X1_binary )
...
for i=1:numquery
    ...
    query_cat = cat_te(i,:);
%     point_plot = point_plot_perc * (query_cat * nb_num);
